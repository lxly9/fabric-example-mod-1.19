...
public class BlessedCandleBlock
    ...
    public BlessedCandleBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (player.getAbilities().allowModifyWorld && player.getStackInHand(hand).isEmpty() && state.get(LIT)) {
            net.minecraft.block.CandleBlock.extinguish(player, state, world, pos);
   ...
   /@Override
    ...
    public boolean tryFillWithFluid(WorldAccess world, BlockPos pos, BlockState state, FluidState fluidState) {
        ...
        if (state.get(LIT)) {
            net.minecraft.block.CandleBlock.extinguish(null, blockState, world, pos);
        } else {
